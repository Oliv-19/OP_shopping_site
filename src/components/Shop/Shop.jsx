        ...
        <div className={styles.card}>
            ...
            <div className={styles.productText}>
                ...
                <p className={styles.price} >{`$${product.price}`}</p>
                    {isInCart?(
                        <button onClick={removeFromCart} className={styles.removeFromCart} title={isInCart ? 'Remove from cart' : 'Add to cart'}>
                        ...
                        <button onClick={addToCart} className={styles.addToCart} title={isInCart ? 'Remove from cart' : 'Add to cart'}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
